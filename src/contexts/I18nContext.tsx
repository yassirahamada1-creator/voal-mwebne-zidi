...
const defaultTranslations = {
  fr: {
    ...
    pages: {
      ...
      category: {
        searchPlaceholder: "Rechercher dans les contenus...",
        suggestionsEmpty: "Aucune suggestion",
        videoBadge: "Vidéo",
        emptyVideos: "Aucune vidéo pour cette catégorie.",
        galleryLabel: "Galerie",
      },
      gallery: {
        label: "Galerie",
        title: "Photos d'archive du CNDRS",
        searchPlaceholder: "Rechercher un sujet…",
        searchAria: "Rechercher dans la galerie",
      ...
      media: {
        ...
        offlineTitle: "Contenu non disponible hors-ligne",
        offlineHint: "Téléchargez ce contenu lorsque vous êtes connecté pour le consulter sans réseau.",
        relatedHeading: "Contenus liés",
        tabsAria: "Types de contenus liés",
        noRelated: "Aucun contenu pour le moment.",
        tabStory: "Récit",
        tabTestimony: "Témoignage",
        tabPhoto: "Photo",
        titleUnavailable: "Titre indisponible",
        noTitleFr: "Ce contenu n'a pas encore de titre en français.",
        noTitleShk: "Ce contenu n'a pas encore de titre en shikomori.",
      },
      quiz: {
  ...
  shi: {
    ...
    pages: {
      ...
      category: {
        ...
        suggestionsEmpty: "Hakuna mapendekezo",
        videoBadge: "Video",
        emptyVideos: "Hakuna video.",
        galleryLabel: "Picha",
      },
      gallery: {
        label: "Galeri",
        title: "Picha za hazina za CNDRS",
        searchPlaceholder: "Tafuta mada…",
        searchAria: "Tafuta katika galeri",
        clearSearch: "Futa utafutaji",
        noResults: "Hakuna matokeo.",
        noSubjects: "Hakuna mada bado.",
        photoSingular: "picha",
        photoPlural: "picha",
      },
      media: {
        notFound: "Maudhui hayapatikani.",
        swipeBack: "Telezesha kutoka ukingoni wa kushoto kurudi.",
        offlineTitle: "Maudhui hayapatikani bila mtandao",
        offlineHint: "Pakua maudhui haya ukiwa na mtandao ili uweze kuyatumia bila mtandao.",
        relatedHeading: "Maudhui yanayohusiana",
        tabsAria: "Aina za maudhui yanayohusiana",
        noRelated: "Hakuna maudhui kwa sasa.",
        tabStory: "Hadithi",
        tabTestimony: "Ushuhuda",
        tabPhoto: "Picha",
        titleUnavailable: "Hakuna kichwa",
        noTitleFr: "Maudhui haya hayana bado kichwa kwa Kifaransa.",
        noTitleShk: "Maudhui haya hayana bado kichwa kwa Shikomori.",
      },
      quiz: {
