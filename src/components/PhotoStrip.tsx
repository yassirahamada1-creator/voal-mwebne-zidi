  ...
  return (
    <>
      ...
      >
        {uniquePhotos.map((p, i) => (
          <button
            ...
            className="relative flex-shrink-0 snap-start h-16 w-16 sm:h-20 sm:w-20 overflow-hidden rounded-xl border border-secondary/30 bg-muted shadow-md ring-1 ring-secondary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
            <OfflineImage
      ...
      {peek > 0 && (
        <div
          aria-hidden="true"
          className="pointer-events-none fixed inset-y-0 left-0 z-[100] ,opacity]"
          style={{
            width: peek,
