        ...
        <section>
          ...
          {loading ? (
            <div className="grid grid-cols-2 gap-3">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="card-cultural h-24 opacity-0" aria-hidden="true" />
              ))}
            </div>
          ) : (
            <div className="grid grid-cols-2 gap-3">
              {modules.map((mod, i) => {
                ...
                return (
                  <button
                    ...
                    className="card-cultural card-cultural-interactive flex flex-col items-center gap-2 p-4 min-h-[44px]"
                  >
