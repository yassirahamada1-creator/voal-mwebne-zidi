...
const QuizScreen = () => {
      ...
      <div className="flex min-h-dvh flex-col items-center justify-center bg-background px-6 text-center">
        <div>
          ...
          <div className="mt-8 flex gap-3">
            <button
              onClick={restart}
              className="btn-comorian flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-semibold"
            >
            ...
            <button
              onClick={() => {}}
              className="flex items-center gap-2 rounded-xl bg-secondary px-6 py-3 text-sm font-semibold text-secondary-foreground"
            >
  ...
  return (
    <div className="min-h-dvh bg-background pattern-comorian pb-20">
      <ScreenHeader
        icon={Brain}
        labelFr="Quiz"
        labelShi="Maswali"
      ...
      <div className="px-4 mt-8">
          ...
          {Array.from({ length: visibleCount }).map((_, idx) => {
            ...
            return (
              <button
                ...
                disabled={answered}
                className={`w-full rounded-xl border-2 p-4 text-left text-sm font-medium${style}`}
              >
        ...
        {answered && (
          <div className="mt-4">
            ...
            <button
              onClick={handleNext}
              className="btn-comorian mt-4 w-full rounded-xl py-3 text-sm font-semibold"
            >
