      ...
      <div className="px-4 mt-4 space-y-5">
        ...
        <div className="grid grid-cols-1 gap-2.5">
          {openSourceLibraries.map((lib) => (
            ...
            >
              <div className="rounded-lg bg-muted/60 p-2 shrink-0 group-hover:bg-secondary/15">
                <Package className="h-4 w-4 text-muted-foreground group-hover:text-secondary" />
              </div>
