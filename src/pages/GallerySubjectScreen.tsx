      ...
      <div className="px-4 mt-2">
        {loading ? (
          <div className="grid grid-cols-3 gap-2">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="aspect-square rounded-lg bg-muted/40 opacity-0" aria-hidden="true" />
            ))}
          </div>
        ) : photos.length === 0 ? (
            ...
            {photos.map((p, i) => {
              ...
              return (
                <button
                  ...
                  className="group relative aspect-[3/4] overflow-hidden rounded-2xl border border-secondary/30 bg-muted shadow-md ring-1 ring-secondary/10 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                >
                  <OfflineImage
