...
import { LayoutDashboard, FolderKanban, FileText, CircleHelp as HelpCircle, Languages, LogOut, Moon, ExternalLink, Flower2 } from "lucide-react";
import {
  AdminLogin,
  DashboardTab,
  ModulesTab,
...
export default function Dashboard() {
  ...
  return (
    <SidebarProvider>
      <div className="min-h-dvh flex w-full bg-gradient-to-br from-slate-50 via-white to-indigo-50/40">
