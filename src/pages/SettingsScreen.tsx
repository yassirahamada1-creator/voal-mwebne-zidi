          ...
          {themeOpts.map((opt) => {
            ...
            return (
              <button
                ...
                aria-pressed={active}
                className={`min-h-[64px] rounded-xl border-2 p-2 flex flex-col items-center justify-center gap-1${
                  active
          ...
          {sizes.map((s) => {
            ...
            return (
              <button
                ...
                aria-pressed={active}
                className={`min-h-[56px] rounded-xl border-2 p-2${
                  active
                    ? "border-primary bg-primary/10 text-primary"
                    : "border-border bg-card text-foreground hover:border-primary/40"
                }`}
          ...
          {contrasts.map((c) => {
            ...
            return (
              <button
                ...
                aria-pressed={active}
                className={`min-h-[48px] rounded-xl border-2 px-3 py-2 text-sm font-medium${
                  active
                    ? "border-primary bg-primary/10 text-primary"
                    : "border-border bg-card text-foreground hover:border-primary/40"
                }`}
            ...
            {fonts.map((opt) => {
              ...
              return (
                <button
                  ...
                  aria-pressed={active}
                  className={`flex-shrink-0 w-28 snap-start rounded-xl border-2 p-2.5 text-center${
                    active
  ...
  return (
    <div className="min-h-dvh bg-background pb-24">
      ...
      <div className="px-4 mt-5">
        ...
        {/* Partenaires */}
        <section className="card-cultural mt-3 border-l-2 border-l-accent/60 p-5 pattern-salouva bg-card text-card-foreground">
              ...
              <div className="flex flex-col items-center gap-4">
                {wide && (
                  <a
                    ...
                    className={`${frame}h-20 w-full max-w-xs cursor-pointer`}
                  >
                ...
                <div className="flex w-full items-center justify-center gap-3">
                  {small.map((cell) => (
                    <a
                      ...
                      className={`${frame}h-20 w-20 cursor-pointer`}
                    >
